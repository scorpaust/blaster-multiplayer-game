...
FString ABlasterPlayerController::GetTeamsInfoText(class ABlasterGameState* BlasterGameState)
{
	...
	ABlasterPlayerState* BlasterState = Cast<ABlasterPlayerState>(PlayerState);

	FString InfoTextString;

	FString PlayerScoreString = FString::Printf(TEXT("%s %d"), *Announcement::YourIndividualScore, static_cast<int32>(BlasterState->Score));
	...
	InfoTextString.Append(PlayerScoreString);
